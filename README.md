...
[![Ainulindale - Post Installation Instructions](https://github.com/Fingolfin420/Ainulindale/blob/main/page_assets/morgoth_fingolfin.jpg)](https://www.youtube.com/watch?v=1hec5EjI-g0)
...
Below their are instructions specific to PGPatcher, since it is slightly more complicated for the user that must sort texture mods in a pop-ip when running the tool. Images and instructions are provided in case people prefer static examples over a video. 
